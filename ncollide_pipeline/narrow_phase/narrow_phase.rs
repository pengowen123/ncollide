...
use narrow_phase::{ContactAlgorithm, ContactSignal, ContactGenerator, ProximityAlgorithm,
                   ProximitySignal, ProximityDetector};
...
pub trait NarrowPhase<P: Point, M, T>: Send + Sync {
